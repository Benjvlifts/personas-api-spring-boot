...
import static com.gateway.redireccion.personas.PersonaPublicRoutes.*; //importa las rutas publicas de API Personas
import static com.gateway.redireccion.productos.ProductoPublicRoutes.*; //importa las rutas publicas de API Productos
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.csrf(csrf -> csrf.disable())
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, PERSONAS_PUBLIC_GET).permitAll()   // lista pública api Personas GET
